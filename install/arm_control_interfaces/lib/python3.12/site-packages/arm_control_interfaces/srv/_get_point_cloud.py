...
class GetPointCloud_Event(metaclass=Metaclass_GetPointCloud_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<arm_control_interfaces/GetPointCloud_Request, 1>',
        'response': 'sequence<arm_control_interfaces/GetPointCloud_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['arm_control_interfaces', 'srv'], 'GetPointCloud_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['arm_control_interfaces', 'srv'], 'GetPointCloud_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from arm_control_interfaces.srv import GetPointCloud_Request
    ...
    def response(self, value):
        if self._check_fields:
            from arm_control_interfaces.srv import GetPointCloud_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_GetPointCloud(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'arm_control_interfaces.srv.GetPointCloud')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from arm_control_interfaces.srv import _get_point_cloud
...
class GetPointCloud(metaclass=Metaclass_GetPointCloud):
    from arm_control_interfaces.srv._get_point_cloud import GetPointCloud_Request as Request
    from arm_control_interfaces.srv._get_point_cloud import GetPointCloud_Response as Response
    from arm_control_interfaces.srv._get_point_cloud import GetPointCloud_Event as Event
